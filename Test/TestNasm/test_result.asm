...
label349:
       ...
       mov  rcx,  rbx
       add  rcx,  1
       mov  r15,  qword [r9 + rcx * 8]
       add  r12,  r15
       mov  r14,  qword [rbp-8]
       mov  r13,  r14
       add  r13,  1
       mov  qword [r11 + r13 * 8],  r12
       mov  r8,  qword[Comb]
       mov  rbx,  r8
       mov  r9,  r10
       add  r9,  1
